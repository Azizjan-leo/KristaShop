...
namespace KristaShop.DataAccess.Entities.DataFrom1C {
    /// <summary>
    /// Configuration file for this entity <see cref="Configurations.DataFrom1C.MoneyDocumentItemSqlViewConfiguration"/>
    /// </summary>
    public class MoneyDocumentItemSqlView : ICountableCatalogItem {
