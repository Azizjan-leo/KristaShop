...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210710114728_UpdateCatalog")]
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Configurations.DataFrom1C.Barcode", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration573f33aa0ddf4ffea7e2cd6d17a36677")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration8b1e140f4af545f8bb138d4b97eb0a7f")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CartItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration7b0a15047bc44965bb02f7702878338b")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationb8ce98936181487dba3f6532e5800746")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb30069438f754f228014c903d6f196e5")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CatalogItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Catalog", "Catalog")
                        ...
                        .HasForeignKey("CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigration128dfcf00344407d8145c54753df5dd9")
                        .HasPrincipalKey("Id")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigratione0d2fe6bf2ba43b4913300ace79bdfa9")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("CatalogItems")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration14b7c8d7bff743f389b5908f02117130")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogOrder", "ModelCatalogOrder")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration50d7a1272fbf43288450eb864b2a3410");

                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogsInvisibility", "Invisibility")
                        .WithMany()
                        .HasForeignKey("Articul", "CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigration5df95040dc124f2b9056568a6d6eecb6")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemVisibility", "ItemVisibility")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationba24e84189044ea8bd0b9c8252b5947a")
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Color", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.ColorGroup", "Group")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration099c4b0fede146bea5b240ebbc24fdfa");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Model", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemDescriptor", "Descriptor")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration05cbd7990aaa4b5fa5adeb5ca5230a48")
                        .OnDelete(DeleteBehavior.ClientNoAction);

                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        .WithMany()
                        .HasForeignKey("CollectionId")
                        .HasConstraintName("ExcludeForeignKeyMigration2d7200cb5960463ebd972125daf11ec9");

                    b.HasOne("KristaShop.DataAccess.Entities.Material", "Material")
                        .WithMany("Models")
                        .HasForeignKey("MaterialId")
                        .HasConstraintName("ExcludeForeignKeyMigration68548c16b5d44a5694b5b8f5805f5b31")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Shipment", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration9e47d0b8fe28431eab60c182171e4b3e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration581310ab8ef64fb2bf8440714dc3d936")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration6d8500c101f049e4a9d90542afe9e68f")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Manager", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFor1C.ManagerDetails", "Details")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration308948a0ceb14d459ba63dff3a3a976c")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelCategory", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Category", "Category")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration086db324438048b181895ccb38c5c924")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("Categories")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration23f7c2a8d3954e61b8df717e7c19afb4")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelPhoto1C", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration5210cbea715c47f3add96b04f8fcfedf")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Document", b =>
                {
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.Partners.Partner", "Partner")
                        .WithMany("Documents")
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration95bfccde577b4dbea772c346312d0035")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration90e76f925ce64c608b2e2740ed07e704")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationa7a6dbc9693d47e0a8b3dcbc5d2d844c")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Partner", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigrationb10a40cfcbdc47189b75b24d7641b148")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.User", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.City", "City")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration497873629a0d492ab790d3b05666c56d");

                    b.HasOne("KristaShop.DataAccess.Entities.Manager", "Manager")
                        .WithMany("Users")
                        .HasForeignKey("ManagerId")
                        .HasConstraintName("ExcludeForeignKeyMigration16f591c6f1de47daa158f1b5c356dfe2");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.UserData", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationab3d79dc15d0400bac192f850353d956")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
