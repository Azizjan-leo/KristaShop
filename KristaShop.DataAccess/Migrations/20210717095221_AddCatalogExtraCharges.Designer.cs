...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210717095221_AddCatalogExtraCharges")]
    partial class AddCatalogExtraCharges
    {
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Configurations.DataFrom1C.Barcode", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigratione6e67f0b9bfc47e48df8a2076e31f652")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration848457ab9e9a4fb2aff8c16cee51965d")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CartItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration10b616c1734b44c09f032335195c279a")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration7641496ec7af45d2ad17ef08afb7bc19")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationbc5300660dd24afb92cc0d4eac39e3c9")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CatalogItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Catalog", "Catalog")
                        ...
                        .HasForeignKey("CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigrationb7e1872311444953922886b830e67bdf")
                        .HasPrincipalKey("Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigratione1a05283c14b4c84afd061288a49e846")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("CatalogItems")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration8be35cc5010d4317a59b89545155eab0")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogOrder", "ModelCatalogOrder")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration0f4f600a32264b8899cc0610cc81e392");

                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogsInvisibility", "Invisibility")
                        .WithMany()
                        .HasForeignKey("Articul", "CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigrationd5d04e6217194b0aa793ba80138e325b")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemVisibility", "ItemVisibility")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration7d66ac3c18c443f0b318d1693da15ccd")
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Color", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.ColorGroup", "Group")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration5aeeb3a71cef478e9b3e073eb101582f");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Model", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemDescriptor", "Descriptor")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration42a8cb34e78c4afe98c7f6dd68ccecc7")
                        .OnDelete(DeleteBehavior.ClientNoAction);

                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        .WithMany()
                        .HasForeignKey("CollectionId")
                        .HasConstraintName("ExcludeForeignKeyMigrationa4a2a6b2b1a04c74ba284b18b7903492");

                    b.HasOne("KristaShop.DataAccess.Entities.Material", "Material")
                        .WithMany("Models")
                        .HasForeignKey("MaterialId")
                        .HasConstraintName("ExcludeForeignKeyMigrationf24224c158a247ad919da3407ee40423")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Shipment", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationb14e0f825e054eb3a7e8c33eb9a66c1c")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationbcae09c21f9545689e20175636bea7a3")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigrationbe644fba1eb044d586f581ab7e5b576a")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Manager", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFor1C.ManagerDetails", "Details")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration6809a53edfa64ab2a4b3e55a2f0e247e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelCategory", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Category", "Category")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigratione773c21bcea640d289eef0edbe14b06d")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("Categories")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration4523514c70b14c5aa4876bdbdced1ad7")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelPhoto1C", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration79912acbb80443019f3384677370622c")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Document", b =>
                {
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.Partners.Partner", "Partner")
                        .WithMany("Documents")
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration27d0888b80504f5b9ac5466394370190")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration98d2a50cb08a44b5991e8ac4dcde09a2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration86967dd979924dad8587dd8954746f94")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Partner", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration493e6149a10b4f97b42174349d965902")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.User", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.City", "City")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationa972c11071da40c38c7181d446ce0bb6");

                    b.HasOne("KristaShop.DataAccess.Entities.Manager", "Manager")
                        .WithMany("Users")
                        .HasForeignKey("ManagerId")
                        .HasConstraintName("ExcludeForeignKeyMigration8a320097a95345ec9ae577f8bd149679");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.UserData", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigratione168f8c16353465881c6cefbe1e4305e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
