...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210219034046_AddReportsMenu")]
    partial class AddReportsMenu
    {
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("1e32f8c8-c857-4f37-bd30-39bbe6864dc1"),
                            ActionName = "CartsReport",
                            AreaName = "Admin",
                            ControllerName = "Cart",
                            Icon = "",
                            MenuType = 1,
                            Order = 10,
                            ParentId = new Guid("02f3a86a-1ff5-40f8-9ca5-ab76b2db1d7c"),
                            Title = "Расшифровка по моделям в корзинах"
                        },
                        new
                        {
                        ...
                        new
                        {
                            Id = new Guid("fd5ef88c-b1fe-4ee5-9df5-2661debdc381"),
                            ActionName = "TotalPreOrderReport",
                            AreaName = "Admin",
                            ControllerName = "OrderReports",
                            Icon = "",
                            MenuType = 1,
                            Order = 20,
                            ParentId = new Guid("02f3a86a-1ff5-40f8-9ca5-ab76b2db1d7c"),
                            Title = "Сводный отчет по предзаказу"
                        },
                        new
                        {
