...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210529060727_AddDocumentMovementDirectionToEntity")]
    partial class AddDocumentMovementDirectionToEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItems", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)")
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Colors", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.ColorGroup", "Group")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationf790540675dc4578bff4bd4a0a539b0c");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Model", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemDescriptor", "Descriptor")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration00b9435e11744fa7a8070a3554c6dde7")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationaff6a7bc347540df9a6b513212cfcfc5");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItems", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Colors", "Color")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationf34d3490246448f1aa9227010928dbff")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationdb7b727aaab340d189b67e13c979f03e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
