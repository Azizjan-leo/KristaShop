...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210614111835_PartnerTopMenuItems")]
    partial class PartnerTopMenuItems
    {
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Colors", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.ColorGroup", "Group")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration5a40bd75bec34914837e6e135befe8cc");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Model", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemDescriptor", "Descriptor")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration2d21354390d2453885e373885915b1eb")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration7d64792fc56b43349f4a8fd9f4e28738");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Manager", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFor1C.ManagerDetails", "Details")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationc2d16447e862455ba54a40f4e387e4aa")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Document", b =>
                {
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb3673e3ad6bf4327afcb93006c77ec46")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Colors", "Color")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration5167e31dc3d240c7b6268cbeb17f0863")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration2a8f315ef6e54b2bb4205bcfb0a22a93")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.User", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.City", "City")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration411a258edd49406e91caeb083c3a652c");

                    b.HasOne("KristaShop.DataAccess.Entities.Manager", "Manager")
                        .WithMany("Users")
                        .HasForeignKey("ManagerId")
                        .HasConstraintName("ExcludeForeignKeyMigrationbd2be9c530b641df830b838cc78dc3a7");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.UserData", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration7e549251b4734b9cb834ac39383b18d5")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
