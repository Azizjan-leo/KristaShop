...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210729115810_AddCollectionToOrderItem")]
    partial class AddCollectionToOrderItem
    {
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Configurations.DataFrom1C.Barcode", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationc5099b77e80f4821afef8489e5c0157b")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration50039e907440441287a2a34f60af0f42")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CartItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationcd3019ebc22f48e1b4268eae9b7b14ff")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationddaecc2caacd4840bba47e95dddd4b2e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationbe8370cc6a7749ddbaab4563b25e1dbd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CatalogItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Catalog", "Catalog")
                        ...
                        .HasForeignKey("CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigration4fd92dc191f749f695c01eda94e00279")
                        .HasPrincipalKey("Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationf35f158134ee40df8ae6700d95615f85")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("CatalogItems")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration10e5891a9cf64dff85e77975d136cfe3")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogOrder", "ModelCatalogOrder")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration6828f935b03444269c25a34a1927b4cd");

                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogsInvisibility", "Invisibility")
                        .WithMany()
                        .HasForeignKey("Articul", "CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigration24b3629236b94b76b2c13a93dd8c4220")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemVisibility", "ItemVisibility")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration3bac4e89baed4e6cb608620a6158ffa5")
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Color", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.ColorGroup", "Group")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration8c4c2b4ef17c43119f898f2b835ca4ac");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Model", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemDescriptor", "Descriptor")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb07175d71e57430b9e2d9ce5941ea27b")
                        .OnDelete(DeleteBehavior.ClientNoAction);

                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        .WithMany()
                        .HasForeignKey("CollectionId")
                        .HasConstraintName("ExcludeForeignKeyMigration228f2f8982bd412fa9394ee61537b51a");

                    b.HasOne("KristaShop.DataAccess.Entities.Material", "Material")
                        .WithMany("Models")
                        .HasForeignKey("MaterialId")
                        .HasConstraintName("ExcludeForeignKeyMigration9c047689e6cc4071aee12a04b1231fd2")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Shipment", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        .WithMany()
                        .HasForeignKey("CollectionId")
                        .HasConstraintName("ExcludeForeignKeyMigration0ec9feda297b40d081465b0093d87500");

                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration18c67948e12643cfb7fefcf343fe1653")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration707835c683a7473fb40d2a5347d6915d")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration4c987ed5bdfb4dda8c7bf3e6eef796f7")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Manager", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFor1C.ManagerDetails", "Details")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration9ccf447c09f24154bad3e6a0c26adad4")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelCategory", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Category", "Category")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration07be9208eb9d47489a289db8622a2589")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("Categories")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration1dca0f82a7444545812f50dde5f05d7b")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelPhoto1C", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationb83eaacb5539405c93e182fad6b66696")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Document", b =>
                {
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.Partners.Partner", "Partner")
                        .WithMany("Documents")
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration5374ba4280b641679bf603a626074c0c")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationd18a8671166a43cfbfea12d1d60a7452")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationa1471b8330ac40b0a78fb138e24209d5")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Partner", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigrationda849a94fa0c48deba1007be5271c0ea")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.User", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.City", "City")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationab2def17da2d4f76b66b89d1fd95887a");

                    b.HasOne("KristaShop.DataAccess.Entities.Manager", "Manager")
                        .WithMany("Users")
                        .HasForeignKey("ManagerId")
                        .HasConstraintName("ExcludeForeignKeyMigration817509b6501c4eaf94ff373f3c8c82f9");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.UserData", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationd52b83485f4f452ab6982c2f33dee215")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
