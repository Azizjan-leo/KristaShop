...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210728053825_ChangeDocumentState")]
    partial class ChangeDocumentState
    {
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Configurations.DataFrom1C.Barcode", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationeb2ec08fc3a34b0f8b7e719ebb128a22")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration2883016785c54ea5a15b4e17c5cd5631")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CartItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationa93b7abf44874481bc673eca8cefbf14")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationedbd759c2636479588db9ddb633f957f")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration37b5bb12a8a14d3099d168a9086ce17e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.CatalogItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Catalog", "Catalog")
                        ...
                        .HasForeignKey("CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigration32d87a1072dd408a89a5e3514970b2e2")
                        .HasPrincipalKey("Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigratione29a6c3051814efcb7f705b68c4974f2")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("CatalogItems")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration0cc76cc573994adea2baa6ff93141690")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogOrder", "ModelCatalogOrder")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration14ac8ab2bc914b83a91c74b22484c347");

                    b.HasOne("KristaShop.DataAccess.Entities.ModelCatalogsInvisibility", "Invisibility")
                        .WithMany()
                        .HasForeignKey("Articul", "CatalogId")
                        .HasConstraintName("ExcludeForeignKeyMigration2cf149cd4c014a76964ba4d0c1bd54c0")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemVisibility", "ItemVisibility")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb8d7bf3d5736445e8547164a744ec029")
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Color", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.ColorGroup", "Group")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationbb86fd23d1c64407b34c2e83d5050f2a");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Model", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.CatalogItemDescriptor", "Descriptor")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb92affeababe4fdd84bd76ca224e4821")
                        .OnDelete(DeleteBehavior.ClientNoAction);

                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Collection", "Collection")
                        .WithMany()
                        .HasForeignKey("CollectionId")
                        .HasConstraintName("ExcludeForeignKeyMigrationbb17f2da7735425591c05a24443fadf2");

                    b.HasOne("KristaShop.DataAccess.Entities.Material", "Material")
                        .WithMany("Models")
                        .HasForeignKey("MaterialId")
                        .HasConstraintName("ExcludeForeignKeyMigration4357ba9e791c47c99a114fe29272b0ee")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Shipment", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration65f04feb8d5a480d9627bd2e5ac49afe")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigrationf6b5ae6a21f242289e2dc58ce4c2f252")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration3faa4cd5da644dc7ad4945f4ce858c33")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Manager", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFor1C.ManagerDetails", "Details")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb7ed6ff7ba654334806edc299bd8d34d")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelCategory", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.Category", "Category")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigrationb7182307762543cabf7889599e05d340")
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany("Categories")
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration33186eea67574dd88ed57553602abd53")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.ModelPhoto1C", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigration2fd200a7c009483983fb789e2e5e2d58")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Document", b =>
                {
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.Partners.Partner", "Partner")
                        .WithMany("Documents")
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigration23932907b22f4f3c8851e68eae23627e")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.DocumentItem", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Color", "Color")
                        .WithMany()
                        .HasForeignKey("ColorId")
                        .HasConstraintName("ExcludeForeignKeyMigrationa4a3e6543df849338f615d7f7eaad501")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.Model", "Model")
                        .WithMany()
                        .HasForeignKey("ModelId")
                        .HasConstraintName("ExcludeForeignKeyMigration9e5abe3723ce4507a4a246fc70c24076")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.Partner", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("ExcludeForeignKeyMigratione19537fb4e7f428cb8068fed8ace4708")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.User", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.DataFrom1C.City", "City")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration4ef3832f0f6040db8eff590ba1ee323e");

                    b.HasOne("KristaShop.DataAccess.Entities.Manager", "Manager")
                        .WithMany("Users")
                        .HasForeignKey("ManagerId")
                        .HasConstraintName("ExcludeForeignKeyMigrationfa3e1d5929c74cb184f7f966563c98bb");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.UserData", b =>
                {
                    b.HasOne("KristaShop.DataAccess.Entities.User", "User")
                        ...
                        .HasConstraintName("ExcludeForeignKeyMigration5e289ef305bc4cf986133284aaa474e6")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
