...
namespace KristaShop.DataAccess.Migrations
{
    ...
    [Migration("20210414052803_FixViewsForNet5")]
    partial class FixViewsForNet5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.City", b =>
                {
                    ...
                    b.ToTable("City", t => t.ExcludeFromMigrations());
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.ClientManufactoringItemSqlView", b =>
                {
                    b.Property<string>("Articul")
                        .HasColumnType("longtext CHARACTER SET utf8mb4")
                        .HasColumnName("articul");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Colors", b =>
                {
                    ...
                    b.ToTable("Colors", t => t.ExcludeFromMigrations());
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.Manager1C", b =>
                {
                    ...
                    b.ToTable("Manager1C", t => t.ExcludeFromMigrations());
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.ModelCount", b =>
                {
                    b.Property<int>("ModelsCount")
                        .HasColumnType("int")
                        .HasColumnName("models_count");

                    b.ToTable("ModelsCount", t => t.ExcludeFromMigrations());

                    b.ToView("1c_models_count");
                });
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.DataFrom1C.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Partners.PartnerStorehouseItemSqlView", b =>
                {
                    b.Property<int>("Amount")
                        .HasColumnType("int")
                        .HasColumnName("amount");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.RoleAccess", b =>
                {
                    ...
                    b.Property<string>("Description")
                        .IsRequired()
                        .HasMaxLength(521)
                        .HasColumnType("varchar(521) CHARACTER SET utf8mb4")
                        .HasColumnName("description");
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.Catalog", b =>
                {
                    ...
                    b.Navigation("NomDiscounts");

                    b.Navigation("NomUserFavorites");

                    b.Navigation("VisibleCatalogUsers");
                });
            ...
            modelBuilder.Entity("KristaShop.DataAccess.Entities.NomDiscount", b =>
                {
                    b.Navigation("DiscountCatalogs");
                });

            modelBuilder.Entity("KristaShop.DataAccess.Entities.NomenclatureModel", b =>
                {
                    b.Navigation("NomCatalogs");

                    b.Navigation("NomCategories");

                    b.Navigation("NomDiscounts");

                    b.Navigation("NomPhotos");

                    b.Navigation("NomUserFavorites");

                    b.Navigation("VisibleNomUsers");
                });
