...
$(document).ready(function () {
    table = $('.table').DataTable({
        stateSave: true,
        "ajax": {
            "url": "/Admin/Orders/LoadDataReservations",
            "type": "GET",
            "datatype": "json",
        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function (data, type, full, meta) {
                    ...
                    detailBtn = '<a href="/Admin/Orders/ReservationsDetails/' + data + '"  class="btn btn-square btn-main-success mr-2" data-toggle="tooltip" data-placement="bottom" title="Подробно"><svg class="krista-icon krista-eye"><use xlink:href="#krista-eye"></use></svg></a>';
...
function ResetOrderAllValues() {
    ...
    //$("#orderDateFromPicker").datetimepicker("clear");
    //$("#orderDateToPicker").datetimepicker("clear");
    table.draw();
