...
namespace KristaShop.Common.Implementation.LockProvider {
    /// <summary>
    ...
    public class LockProvider<T> {
        static readonly LazyConcurrentDictionary<T, InnerSemaphore> lockDictionary =
            new LazyConcurrentDictionary<T, InnerSemaphore>();
