    ...
    table = $('.table').DataTable({
        ...
        "columns": [
            ...
            },
            {
                ...
                "sortable": false,
                "render": function (data, type, full, meta) {
                    return `<button data-href="/Admin/ModelsCatalog/EditHistory/?id=${encodeURIComponent(data)}" class="btn btn-square btn-main-primary mr-2" data-toggle="tooltip" data-placement="bottom" title="Изменить" onclick="EditModel(this);"><svg class="krista-icon krista-edit"><use xlink:href="#krista-edit"></use></svg></button>`;
                },
                "className": "min-desktop"
            }
        ],
